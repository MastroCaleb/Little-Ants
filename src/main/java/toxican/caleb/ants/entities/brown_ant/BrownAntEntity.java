...
public class BrownAntEntity extends AntEntity implements Bottleable{

    private static final TrackedData<Boolean> FROM_BOTTLE = DataTracker.registerData(BrownAntEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    ...
    public AntEntity createChild(ServerWorld world, PassiveEntity passiveEntity) {
        ...
        return AntsEntities.BROWN_ANT.create(world);
    }
    ...
    public ItemStack getBottleItem() {
        return AntsItems.BROWN_ANT_BOTTLE.getDefaultStack();
    }
