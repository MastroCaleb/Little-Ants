...
public class MuddyAntEntity extends AntEntity implements Bottleable{

    private static final TrackedData<Boolean> FROM_BOTTLE = DataTracker.registerData(MuddyAntEntity.class, TrackedDataHandlerRegistry.BOOLEAN);

    public MuddyAntEntity(EntityType<? extends AnimalEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    public AntEntity createChild(ServerWorld world, PassiveEntity passiveEntity) {
        ...
        return AntsEntities.MUDDY_ANT.create(world);
    }
    ...
    public ItemStack getBottleItem() {
        return AntsItems.MUDDY_ANT_BOTTLE.getDefaultStack();
    }
